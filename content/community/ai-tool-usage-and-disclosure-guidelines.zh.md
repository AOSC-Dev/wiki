...
向安同开源社区任一项目提交贡献（不论是修改代码、提交资料，还是撰写提交信息、拉取请求标题和正文、工单标题和正文）时，如出现如下情况，需声明 LLM/大语言模型工具使用情况：
...
如 LLM/大语言模型工具没有参与任何贡献撰写、修改或发布的过程，您无需声明 LLM/大语言模型工具的使用情况。
...
针对 [ABBS 树](https://github.com/AOSC-Dev/aosc-os-abbs)内软件包更新、构建脚本修改等维护型提交，您还需要保证未来能够不借助 LLM/大语言模型工具的辅助独立完成同样的修改。您的贡献内容一旦发布，即代表您承诺如上内容。
