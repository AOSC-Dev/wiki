...
| **YeRUS** | 22666 | AMD EPYC 7H12 @ 2.6 - 3.3GHz | 1TiB | 176s | _Lain Yang_ | Scratch disk at `/buildroots`, create own Ciel workspace; local mirror at http://localhost/debs <br><br> This machine is the succeder of `Ry3950X` which relay port is `22333`. **The `22666` relay port is temporary allocated.** |
...
| Name | Port | CPU | Memory | Speed | Maintainer | Note |
|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| **powernv** | ~~25202~~ | IBM POWER9 CPU (4 cores, 16 threads) | 128GiB | 1293s | _Mingcong Bai_ | Scratch disk at `/buildroots`, create own Ciel workspace; local mirror at http://192.168.88.3/debs |
...
| Name | Port | CPU | Memory | Speed | Maintainer | Note |
|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| **PorterAle** | 28001 | Intel i7-8700T @ 2.40 - 4.00GHz | 16GiB | 996s | _MingcongBai_ | Scratch disk at `/buildroots`, create own Ciel workspace; local mirror at http://192.168.88.3/debs |
| **Taple** | 28002 | AMD Ryzen R5 5600G @ 3.9 - 4.4GHz | 32GiB | 714s | _Lain Yang_ | Scratch disk at `/buildroots`, create own Ciel workspace; local mirror at http://localhost/debs |
