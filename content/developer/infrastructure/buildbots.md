...
| **YeRUS** | ~~22666~~ | AMD EPYC 7H12 @ 2.6 - 3.3GHz | 1TiB | ~~(WAIT FOR TEST)~~ | _Lain Yang_ | This machine is the succeder of `Ry3950X` which relay port is `22333`. **The `22666` relay port is temporary allocated.** |
