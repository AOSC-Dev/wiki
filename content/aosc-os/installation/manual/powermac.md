...
Another consideration is whether your device is capable for a specific variant, please consult the [PowerPC system requirements](@/aosc-os/installation/manual/powermac-notes-sysreq.md) page for more information.
