...
Another consideration is whether your device is capable for a specific variant, please consult the [PowerPC system requirements](@/system/installation/powermac-notes-sysreq.md) page for more information.
